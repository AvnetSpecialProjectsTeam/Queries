...
FROM
	...
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff=ST.Soff AND PsAor.SaleGrp=ST.Sgrp AND PsAor.AccountNbr=ST.AccountNbr
	UNION
	--PH, Soff, Sgrp 
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff=ST.Soff AND PsAor.SaleGrp=ST.Sgrp AND PsAor.AccountNbr IS NULL
	UNION
	--PH, Soff
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff=ST.Soff  AND PsAor.Salegrp IS NULL AND PsAor.AccountNbr IS NULL
	UNION
	--PH
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff IS NULL  AND PsAor.Salegrp IS NULL AND PsAor.AccountNbr IS NULL
	UNION
	--PH, SOff, AccountNbr
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff=ST.Soff AND PsAor.SaleGrp IS NULL AND PsAor.AccountNbr=ST.AccountNbr
	UNION
	--PH, AccountNbr
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff IS NULL AND PsAor.SaleGrp IS NULL AND PsAor.AccountNbr=ST.AccountNbr
	UNION
	--PH, SGrp, AccountNbr
	SELECT ST.SO, ST.Item, CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp) AS PH, PsAor.Saleoff, PsAor.SaleGrp, PsAor.GlobEnter, PsAor.AccountNbr, PsAor.AorEmpId, PsAor.AorId
	FROM ProdAorFin AS PsAor INNER JOIN ##Stbl AS ST ON CONCAT(PsAor.pbg, PsAor.prcstgy, PsAor.tech, PsAor.cc, PsAor.grp)=ST.PH AND PsAor.SaleOff IS NULL AND PsAor.SaleGrp=ST.Sgrp AND PsAor.AccountNbr=ST.AccountNbr) AS EID
...
SELECT PAU.[SOrg#]
      ...
      ,PAU.[Material]
      ,PAU.[MPN]
	  ,SPA.AOREmpID AS [Emp Id]
	  ,SPA.EmpFirstName AS [First Name]
	  ,SPA.EmpLastName AS [Last Name]
      ,PAU.[Pers#No#]
      ,PAU.[Account Type]
      ,PAU.[Sold-to party]
      ,PAU.[Created on]
      ...
      ,PAU.[Value (text)]
      ,PAU.[Crcy]
FROM ProdAorUpload AS PAU LEFT JOIN ProdAorSO AS SPA ON PAU.[Sales Doc#]=SPA.SO AND PAU.[Item]=SPA.Item

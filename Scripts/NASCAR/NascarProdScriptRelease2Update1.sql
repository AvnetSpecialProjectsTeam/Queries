...
/****** Object:  Job [NascarPhase1Prod]    Script Date: 10/23/2017 8:16:02 AM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/23/2017 8:16:02 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'NascarRelease2Prod', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DBAIsPrimary]    Script Date: 10/23/2017 8:16:03 AM ******/
...
END', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [step1]    Script Date: 10/23/2017 8:16:03 AM ******/
...
-- flag desing win registration to product
   update [NascarProd].[dbo].NascarExportLineFinal 
  Set AUTH = ''P''

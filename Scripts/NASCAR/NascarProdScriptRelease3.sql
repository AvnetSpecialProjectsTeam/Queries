...
/****** Object:  Job [NascarPhase1Prod]    Script Date: 10/30/2017 2:02:48 PM ******/
EXEC msdb.dbo.sp_delete_job @job_id=N'617dfb46-5e86-4ff8-a9d0-4d9f90d5324a', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/30/2017 2:02:48 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'NascarRelease3Prod', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DBAIsPrimary]    Script Date: 10/30/2017 2:02:49 PM ******/
...
END', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [step1]    Script Date: 10/30/2017 2:02:49 PM ******/
...
--Remove previous comments from nascar to avoid comment getting too big for column(for 2nd time commenting on same ship and debit
update t1

...
/****** Object:  Job [MdmRowUpdates]    Script Date: 5/16/2017 10:40:56 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 5/16/2017 10:40:56 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DBAIsPrimary]    Script Date: 5/16/2017 10:40:56 AM ******/
...
END', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update MatProdHier]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update Material]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update Party]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update MaterialPlant]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update MatSalesOrg]    Script Date: 5/16/2017 10:40:56 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update VenMatRel]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update VenMatPurOrgPlnt]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update ConditionHeader]    Script Date: 5/16/2017 10:40:56 AM ******/
...
DROP TABLE #AVRTemp', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update ConditionItem]    Script Date: 5/16/2017 10:40:56 AM ******/
